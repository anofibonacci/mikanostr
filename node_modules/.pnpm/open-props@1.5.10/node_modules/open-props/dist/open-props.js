var OpenProps = {
  ...
  "innerShadow1": "inset 0 1px 2px 0 hsl(var(--shadow-color) / calc(var(--shadow-strength) + 9%))",
  "innerShadow2": "inset 0 1px 4px 0 hsl(var(--shadow-color) / calc(var(--shadow-strength) + 9%))",
  "innerShadow3": "inset 0 2px 8px 0 hsl(var(--shadow-color) / calc(var(--shadow-strength) + 9%))",
  "innerShadow4": "inset 0 2px 14px 0 hsl(var(--shadow-color) / calc(var(--shadow-strength) + 9%))",
  "layer1": 1,
  "layer2": 2,
  "layer3": 3,
  "layer4": 4,
