...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_nostr: string;
	...
	export const npm_package_dependencies_javascript_time_ago: string;
	...
	export const npm_package_dependencies_markdown: string;
	...
	export const npm_package_dependencies_websocket_polyfill: string;
	...
	export const npm_package_dependencies_nostr_relaypool: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_nostr: string;
		TERM_PROGRAM: string;
		...
		npm_package_dependencies_javascript_time_ago: string;
		...
		npm_package_dependencies_markdown: string;
		...
		npm_package_dependencies_websocket_polyfill: string;
		NODE_PATH: string;
		...
		npm_package_dependencies_nostr_relaypool: string;
		LOGNAME: string;
